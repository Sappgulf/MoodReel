...
async function testTMDBApiConnectivity() {
    try {
        if (!TMDB_API_KEY) {
            fail('TMDB API connectivity', 'Missing TMDB API key (set VITE_TMDB_API_KEY or REACT_APP_TMDB_API_KEY)');
            return;
        }
...
async function testTMDBSearchEndpoint() {
    try {
        if (!TMDB_API_KEY) {
            fail('TMDB search endpoint', 'Missing TMDB API key (set VITE_TMDB_API_KEY or REACT_APP_TMDB_API_KEY)');
            return;
        }
...
async function testTMDBTVEndpoint() {
    try {
        if (!TMDB_API_KEY) {
            fail('TMDB TV endpoint', 'Missing TMDB API key (set VITE_TMDB_API_KEY or REACT_APP_TMDB_API_KEY)');
            return;
        }
...
async function testTMDBGenresEndpoint() {
    try {
        if (!TMDB_API_KEY) {
            fail('TMDB genres endpoint', 'Missing TMDB API key (set VITE_TMDB_API_KEY or REACT_APP_TMDB_API_KEY)');
            return;
        }
...
async function testTMDBMovieDetails() {
    try {
        if (!TMDB_API_KEY) {
            fail('TMDB movie details', 'Missing TMDB API key (set VITE_TMDB_API_KEY or REACT_APP_TMDB_API_KEY)');
            return;
        }
